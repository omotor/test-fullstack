            ...
            this.validate = function(form) {
                ...
                $timeout(function() {
                    if (_this.checkValid(form)) {
                        ...
                        $scope.$broadcast('$formWithError', form);
                    }
                });
            ...
            function($injector) {
                ...
                var validFunc = function(element, validMessage, validation, scope, ctrl) {
                    ...
                    if ($validationProvider.showSuccessMessage && messageToShow) {
                        ...
                        messageElem.parent('.form-group:first').removeClass('has-error');
                    } else {
                ...
                var invalidFunc = function(element, validMessage, validation, scope, ctrl) {
                    ...
                    if ($validationProvider.showErrorMessage && messageToShow) {
                        ...
                        messageElem.css('display', '');
                        messageElem.parent('.form-group:first').addClass('has-error');
                    } else {
                        messageElem.css('display', 'none');
                        messageElem.parent('.form-group:first').addClass('has-error');
                    }
                ...
                var checkValidation = function(scope, element, attrs, ctrl, validation, value) {
                    ...
                    if (expression.constructor === Function) {
                    	...
                    	var required = eval("scope.$parent."+attrs.ngRequired);
                    	var hide = (angular.isDefined(attrs.ngShow) && (eval("scope.$parent."+attrs.ngShow) || false)  == false) || ( angular.isDefined(attrs.ngHide) && (eval("scope.$parent."+attrs.ngHide) || false) == true);
                    	
                    	if(	(hide || attrs.ngRequired == "false" || required == false) && !value){
